...
public class Message implements Serializable {
	...
	@NotNull(message="log.Message.msgType.NotNull")
	private Byte msgType;

	/** msg_content_type -- 内容类型（0注册成功，1授信申请通过，2授信申请未通过，3贷款申请通过，4贷款申请未通过，5还款提前通知，6还款成功，7逾期未还，8逾期已还，9结清贷款，10系统通知） */
	@NotNull(message="log.Message.msgContentType.NotNull")
	private Byte msgContentType;

	/** title -- 标题 */
	@NotEmpty(message="log.Message.title.NotEmpty")
	@Length(max=50,message="log.Message.title.Length")
	private String title;

	/** is_send -- 是否发送 */
	@NotNull(message="log.Message.isSend.NotNull")
	private Byte isSend;

	/** content -- 消息内容 */
	@NotEmpty(message="log.Message.content.NotEmpty")
	@Length(max=100,message="log.Message.content.Length")
	private String content;

	/** createdon --  */
	@NotNull(message="log.Message.createdon.NotNull")
	private Date createdon;

	/** remark -- 备注 */
	@Length(max=50,message="log.Message.remark.Length")
