...
public class MemberPositioning implements Serializable {
	...
	/** member_id -- 会员id */
	@NotNull(message="member.MemberPositioning.memberId.NotNull")
	private Integer memberId;

	/** latitude --  */
	@NotNull(message="member.MemberPositioning.latitude.NotNull")
	private Double latitude;

	/** longitude --  */
	@NotNull(message="member.MemberPositioning.longitude.NotNull")
	private Double longitude;

	/** detailaddr -- 详细地址 */
	@Length(max=200,message="member.MemberPositioning.detailaddr.Length")
	private String detailaddr;

	/** createdon -- 创建（获取）时间 */
	@NotNull(message="member.MemberPositioning.createdon.NotNull")
