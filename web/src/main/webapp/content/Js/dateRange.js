...
*/
    ...
    $('#' + this.submitBtn).bind('click', function() {
        __method.close(1);
        var st = $('#' + __method.mOpts.startDateId).val(), et = $('#' + __method.mOpts.endDateId).val();
        __method.mOpts.success({'startDate':st, 
								'endDate': et, 
        ...
        var prama = { "mu_user_id": uInfo.mu_id, "start_time": st, "end_time": et };
        getData(prama);
        return false;
    });
    // 日期选择关闭按钮的 click 事件
